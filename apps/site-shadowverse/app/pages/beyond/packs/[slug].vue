<template>
  <main class="pack-page">
    <section class="pack-shell">
      <header class="topbar">
        <NuxtLink to="/beyond/packs" class="back-link">
      ...
      <section v-else class="empty-state">
        ...
        <NuxtLink to="/beyond/packs" class="back-link strong">
          返回卡包列表
...
const pack = computed(() => cardCatalog.beyond.packs.find(set => set.id === slug.value) ?? null);

useHead({
  title: pack.value ? `${pack.value.name} | Beyond | TCG Cards` : 'Pack Not Found | TCG Cards',
});
</script>

...
const loadData = async () => {
    const { data } = await controlGet<FormatAnnouncementProfile[]>('/ptcg/format/announcement');
...
const loadAnnouncement = async () => {
    ...
    const { data: result } = await controlGet<FormatAnnouncement>('/ptcg/format/announcement', {
...
const saveAnnouncement = async () => {
    ...
    await controlPost('/ptcg/format/announcement/save', { data });
...
const applyAnnouncements = async () => {
    ...
    await controlPost('/ptcg/format/announcement/apply');
};

...
export type ModifierInput<Mod extends string[] | Record<string, string> | undefined> = Mod extends never
    ? { }
...
export type CommonCommandInput = CommandInput<{
    operators:    Operator[];
    qualifiers:   Qualifier[];
    modifiers?:   string[] | Record<string, string>;
    pattern:      string;

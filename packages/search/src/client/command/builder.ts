...
import type { CommandInputOption } from '#search/command';
import type { ClientCommandOption, ClientExplainHandler } from './types';
import type { ClientCommandAdapterHandler } from './adapter';

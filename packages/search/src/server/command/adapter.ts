...
import type { CommandBuilder, CommandOption } from '#search/index';
import type { ServerCommandContext, ServerCommandHandler, ServerHandlerCtx, ServerKindReturnMap } from './builder';

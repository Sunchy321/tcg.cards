...
import type { CommandInput, CommandInputOption, CommandOption } from '#search/command';

import type { ServerCommandContext, ServerCommandHandler, ServerKindReturnMap } from './builder';

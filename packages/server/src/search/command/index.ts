...
export type PostAction = OrderBy;
...
export type PostFunc<
    ...
    P,
    X,
> = (arg: Argument<M, O, Q, AR, P, X>) => PostAction;
...
export type CommonServerCommand = CommonCommand & {
    query:  (arg: CommonArgument) => SQL;
    phase?: string;
    post?:  (arg: CommonArgument) => PostAction;
};

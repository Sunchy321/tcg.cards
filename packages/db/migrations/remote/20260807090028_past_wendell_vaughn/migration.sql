DROP INDEX "hearthstone"."idx_announcement_items_resolved_formats";--> statement-breakpoint
DROP INDEX "hearthstone"."idx_announcement_items_resolved_cards";--> statement-breakpoint

...
ALTER TABLE "yugioh"."card_name_variants" ADD CONSTRAINT "card_name_variants_card_id_cards_id_fkey" FOREIGN KEY ("card_id") REFERENCES "yugioh"."cards"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "shadowverse_data"."image_import_failures" ADD CONSTRAINT "image_import_failures_batch_id_image_import_batches_id_fkey" FOREIGN KEY ("batch_id") REFERENCES "shadowverse_data"."image_import_batches"("id");--> statement-breakpoint
